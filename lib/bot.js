...
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*`STATUS SEEN BY JERRY-MD`* _*POWERD BY*_ *JERRY XD Whtsapp Bot*",
FOOTER: process.env.FOOTER || "JERRY-MD",
COPYRIGHT: process.env.COPYRIGHT || "*㋛ JERRY-MD BY JERRY-XD OFFICIAL*",
