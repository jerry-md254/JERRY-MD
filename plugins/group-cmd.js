...
async (conn, mek, m, { from, sender, isGroup, reply, quoted, participants }) => {
    try {
        ...
        try {
            ...
            ppUrl = 'https://img.sanishtech.com/u/82c5beb887a5952725c5210e28cc6a87.png';
        }
...
if (!isAdmins) return reply('You Are Not A Admin')
const G_MUTE = `*GROUP IS CLOSED BY JERRY-MD BOT OWNER*`;
...
if (!isBotAdmins) return reply('You Not A Bot Owner')
if (!isAdmins) return reply('You Are Not A Admin')
const G_UNMUTE = `*GROUP IS OPEN BY JERRY-MD BOT OWNER*`;
...
await conn.sendMessage(from, { react: { text: `✅`, key: mek.key }})
reply('*GROUP ADMIN DEMOTE BY JERRY-MD BOT OWNER*') 
} catch (e) {
reply('*ERROR*')
console.log(e)
}
